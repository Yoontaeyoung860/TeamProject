...
import  com.common.file.MetaOfUploadFile;
import  com.paging.FindCriteria;
import  com.common.file.FileStore;
import  com.dao.board.BoardUploadFileDAO;
import  com.dto.board.BoardDTO;
import  com.dto.board.BoardReqDTO;
import  com.dto.board.BoardUploadFileDTO;
import  com.dto.board.RboardListReqDTO;
import  com.dto.board.SearchDTO;
import  com.form.Code;
import  com.form.LoginMember;
import  com.form.Result;
import  com.form.board.BoardForm;
import  com.form.board.ReplyForm;
import  com.form.board.ModifyBoardForm;
import  com.svc.board.BoardSVC;
import  com.svc.board.GoodBoardSVC;
import  com.svc.board.RboardSVC;
...
public class BoardController {
	...
	public String boardpList(@PathVariable(required = false) String cate,
		 ...
		 fileStore.setFilePath("D:/dandi/src/main/resources/static/img/upload/board/");
	   //요청페이지가 없으면 1페이지로
